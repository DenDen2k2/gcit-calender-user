...
<html lang="en">
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark" >
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php">SportsCalander</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav m-auto my-2 my-lg-0 ">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="gsports.php">Football</a></li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="gscore.php">Football</a></li>
                <li><a class="dropdown-item" href="#">Volleyball</a></li>
                <li><a class="dropdown-item" href="#">Basketball</a></li>
              </ul>
            </li>  
          ...
          <a class="nav-link" href="login.php"> <i style="color: white;" class="fas fa-user-alt"></i> </a>
        ...
        <div class="container2">
          ...
          <form action="login.php">
              <textarea placeholder="Type your comment here"></textarea>
                  <button style="color: #fff !important; background-color: #ff523b !important;" onclick="checker()" type="submit">Comment</button>
          </form>
      </div>
      </div>
    ...
    <script>
        function checker(){
            var result = confirm("You have to login/register to be able to comment. Do you want to login/register?");
            if(result==false){
